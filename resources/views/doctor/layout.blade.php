            ...
            <div class="user">
                <div class="info">
                  ...
                  <div class="collapse" id="collapseExample">
                    <ul class="nav">
                        <li>
                            <a href="{{route('view_information_doctor',['doctor_id'=>Session::get('doctor_id')])}}">
                                <span class="sidebar-normal">Your information</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('change_password_for_doctor',['doctor_id'=>Session::get('doctor_id')])}}">
